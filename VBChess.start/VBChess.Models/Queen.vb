...
Public Class Queen
    ...
    Friend Overrides Function IsMoveValid(newPosition As Point) As Boolean
        ...
        If Math.Abs(newPosition.X - Position.Value.X) <> Math.Abs(newPosition.Y - Position.Value.Y) AndAlso Position.Value.X <> newPosition.X AndAlso Position.Value.Y <> newPosition.Y Then Return False
